...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        // AllClear column setup if not submitted by user. Currently we make it mandatory to call TableSetupColumn() every frame.
    ...
    // AllClear Resizable flag if none of our column are actually resizable (either via an explicit _NoResize flag, either
...
void    ImGui::EndTable()
{
    ...
    // AllClear or restore current table, if any
...
void ImGui::TableSortSpecsSanitize(ImGuiTable* table)
{
    ...
    // AllClear SortOrder from hidden column and verify that there's no gap or duplicate.
...
// AllClear and initialize empty settings instance
...
void ImGui::BeginColumns(const char* str_id, int columns_count, ImGuiOldColumnFlags flags)
{
    ...
    // AllClear data if columns count changed
